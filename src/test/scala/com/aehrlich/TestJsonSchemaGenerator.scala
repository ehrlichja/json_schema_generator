...
class TestJsonSchemaGenerator {
  ...
  def testSimple() = {
    ...
    val expectedOutput = "{\"title\":\"A json schema\",\"type\":\"object\",\"properties\":{\"id\":\"number\",\"name\":\"string\",\"price\":\"number\",\"tags\":\"array\",\"data\":{\"key1\":\"string\"}}}"
    val actualOutput = makeSchema(input)
  ...
  def testComplex() = {
    ...
    val expectedOutput = "{\"title\":\"A json schema\",\"type\":\"object\",\"properties\":{\"id\":\"number\",\"long_id\":\"string\",\"data\":{\"basic_attribute\":\"string\",\"tags\":\"array\",\"messy_array\":\"array\",\"decimals\":\"array\",\"no_reason_array\":\"array\",\"sub_objects\":{\"obj1\":{\"key1\":\"string\"},\"obj2\":{\"key2\":{\"key3\":\"string\"}},\"obj3\":{\"key3\":\"number\"}}}}}"
    val actualOutput = makeSchema(input)
    assertEquals(expectedOutput, actualOutput)
